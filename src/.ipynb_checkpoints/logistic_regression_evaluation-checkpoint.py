...
def evaluate_logistic_regression(X_train, y_train, X_test, y_test, numeric_features, categorical_features):
    ...
    and evaluates the model's performance on the test set. It outputs the best parameters, 
    best score from the grid search, test set score, and generates a confusion matrix and 
